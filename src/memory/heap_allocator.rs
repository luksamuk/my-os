...
/// A simple allocator which allocates memory linearly
/// and ignores freed memory.
#[derive(Debug)]
...
/// Align downwards.
/// Returns the greatest x with alignment `align`,
/// so that x <= addr. Alignment must be a power of 2.
